	...
	<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
      ...
      <div class="post single hentry">
        <div class="postContent">
          <h3 class="entry-title" align=left><?php the_title(); ?></h3>
...
*/ ?>
  ...
  <div class="pageNav">
    ...
    <div class="prev"><?php previous_post_link('%link', '<button class="download-itunes">&laquo; Previous Post</button>'); ?></div>
    <div class="next"><?php next_post_link('%link', '<button class="download-itunes">Next Post &raquo;</button>') ?></div>
